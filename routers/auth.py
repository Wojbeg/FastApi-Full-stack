...
from utils.token import authenticate_user, create_access_token, SECRET_KEY, ALGORITHM
...
@router.get("/logout")
async def logout(request: Request, msg = "Logout Successful"):
...
async def register_user(request: Request, email: str = Form(...), username: str = Form(...),
    ...
    if password != password_repeat or validation1 is not None or validation2 is not None:
